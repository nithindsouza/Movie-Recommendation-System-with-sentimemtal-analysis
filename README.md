...
Check out the live demo: https://hollywoodmovie.herokuapp.com/
...
3. Replace YOUR_API_KEY in **both** the places of (line 15 and 29)  `static/recommend.js` file and hit save.
